...
sql = "CREATE TABLE IF NOT EXISTS keys("
	...
	//SQlite databse query
    string sql("INSERT INTO IF NOT EXISTS keys ('key') VALUES ('priv_key');"
               "INSERT INTO IF NOT EXISTS keys ('key') VALUES ('priv_key');");
